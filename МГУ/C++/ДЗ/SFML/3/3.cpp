...
int main()
{
	...
	Texture t;
	t.loadFromFile("C:/Users/IRS/Desktop/C++/ДЗ/SFML/3/image");
	Sprite tiles(t);

	Texture sn;
	sn.loadFromFile("C:/Users/IRS/Desktop/C++/ДЗ/SFML/3/image");
	Sprite snake(sn);

	Texture ap;
	ap.loadFromFile("C:/Users/IRS/Desktop/C++/ДЗ/SFML/3/image");
	Sprite apple(ap);

	Texture go;
	go.loadFromFile("C:/Users/IRS/Desktop/C++/ДЗ/SFML/3/image");
	Sprite gameover(go);
